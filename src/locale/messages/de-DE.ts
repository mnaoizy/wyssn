export default {
    ...
    'hero': {
        ...
        'description': 'Ihr KI-gesteuerter Gesprächsbegleiter, der Ihnen hilft, bedeutungsvolle Dialoge mit kontextuell passenden Vorschlägen zu führen.',
    ...
    'footer': {
        ...
        'contact': 'Kontakt',
        'copyright': '© 2025 WYSSN. Alle Rechte vorbehalten.'
    },
    ...
    'account': {
        ...
        'error_no_customer': 'Sie haben noch kein Stripe-Kundenkonto. Bitte abonnieren Sie zuerst.',
        'error_portal_failed': 'Zugriff auf das Abrechnungsportal fehlgeschlagen. Bitte versuchen Sie es später erneut.',
        'error_generic': 'Ein Fehler ist aufgetreten. Bitte versuchen Sie es erneut.',
        'current_usage': 'Aktuelle Nutzung: {count} / {limit} Anfragen in diesem Monat',
