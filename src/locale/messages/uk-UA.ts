export default {
  ...
  contact: {
    ...
    errors: {
      ...
      email_invalid: 'Будь ласка, введіть дійсну електронну пошту',
      rate_limit: 'Забагато запитів. Будь ласка, спробуйте пізніше.',
      generic_error: 'Не вдалося надіслати повідомлення. Будь ласка, спробуйте ще раз.'
    }
  },
