export default {
    ...
    'hero': {
        ...
        'description': 'Il tuo compagno di conversazione alimentato da LLM che ti aiuta a mantenere dialoghi significativi con suggerimenti contestuali appropriati.',
    ...
    'footer': {
        ...
        'terms': 'Termini',
        'contact': 'Contatti',
        'copyright': '© 2025 WYSSN. Tutti i diritti riservati.'
    },
    'categories': {
    ...
    'account': {
        ...
        'error_no_customer': 'Non hai ancora un account cliente Stripe. Per favore abbonati prima.',
        'error_portal_failed': 'Impossibile accedere al portale di fatturazione. Riprova più tardi.',
    ...
    'plans': {
        ...
        'features': {
            ...
            'requests_free_daily': 'Limitato a 50 richieste al giorno',
